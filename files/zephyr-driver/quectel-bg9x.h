...
#define MDM_SOCKET_OPEN_ATTEMPTS	  3
#define MDM_WAIT_FOR_RSSI_COUNT		  10
#define MDM_WAIT_FOR_RSSI_DELAY		  K_SECONDS(2)
#define MDM_RUNTIME_AP_READY_SETTLE	  K_MSEC(500)
#define MDM_RUNTIME_RECOVER_SETTLE	  K_MSEC(500)
#define MDM_RUNTIME_POST_PWRKEY_SETTLE	  K_MSEC(1500)
...
struct modem_data {
	...
	bool socket_nonblock[MDM_MAX_SOCKETS];
